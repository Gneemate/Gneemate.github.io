    ...
    MainGameJS: [function(e, t) {
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            onLoad: function() {
                ...
                this.myFish = this.playerNode.getChildByName("kedou"), this.CreateEnemy(80), this.waterCount = 0, this.randnum = 10, this.angle = 0, this.rotSpeed = 3000, this.addSpeed = 65, this.maxTypeID = 1, this.canTouchReplay = !1;
                for (var c = 0; c < 9; c++) {
